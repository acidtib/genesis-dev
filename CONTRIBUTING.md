...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the weycash unit tests or QA tests
...
The following applies to code changes to the weycash Core project, and is not to be
confused with overall weycash Network Protocol consensus changes.
