...
RESOURCES += src/qt/weycash.qrc src/qt/weycash_locale.qrc

TRANSLATIONS += src/qt/locale/weycash_bg.ts \
                src/qt/locale/weycash_de.ts \
                src/qt/locale/weycash_en.ts \
                src/qt/locale/weycash_es.ts \
                src/qt/locale/weycash_fi.ts \
                src/qt/locale/weycash_fr.ts \
                src/qt/locale/weycash_it.ts \
                src/qt/locale/weycash_ja.ts \
                src/qt/locale/weycash_pl.ts \
                src/qt/locale/weycash_pt.ts \
                src/qt/locale/weycash_ru.ts \
                src/qt/locale/weycash_sk.ts \
                src/qt/locale/weycash_sv.ts \
                src/qt/locale/weycash_vi.ts \
                src/qt/locale/weycash_zh_CN.ts \
                src/qt/locale/weycash_zh_TW.ts
