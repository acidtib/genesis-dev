...
This mechanism has been integrated into Bitcore-Node-weycash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/weycash/insight-api-weycash#web-socket-api](https://github.com/weycash/insight-api-weycash#web-socket-api)
* API: [https://github.com/weycash/insight-api-weycash#swifttx-transactions](https://github.com/weycash/insight-api-weycash#swifttx-transactions)
...
By default, the weycash Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the weycash Core daemon:
