...
<context>
    ...
    <message>
        ...
        <translation>모든 트랜잭션이 표시되지는 않습니다. 모든 트랜잭션을 보려면 구성 파일 (reex.conf)에 txindex = 1을 설정해야합니다.</translation>
    </message>
</context>
<context>
...
자동 저장 기능이 활성화 된 경우이 비율은 구성된 자동 저장 비율 (기본값 = 10 %)을 기준으로 정해집니다.</translation>
    ...
    <message>
        ...
        <translation>자동생성 기능을 사용하지 않으시려면, reex.conf 화일에 enablezeromint=0 를 추가하세요.</translation>
    </message>
    <message>
...
- 활성화: 'enablezeromint=1' 를 reex.conf 파일에 추가
- 비활성화: 'enablezeromint=0' 를 reex.conf 파일에 추가
