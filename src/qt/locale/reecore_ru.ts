...
<context>
    ...
    <message>
        ...
        <translation>Будут показаны не все транзакции. Для отображения всех транзакций необходимо выставить txindex=1 в конфигурационном файле (reex.conf).</translation>
    </message>
</context>
<context>
...
Если АвтоЧеканка включена, этот процент будет располагаться на настроенном проценте АвтоЧеканка  (по умолчанию = 10%).
    ...
    <message>
        ...
        <translation>To disable AutoMint add 'enablezeromint=0' in reex.conf.</translation>
    </message>
    <message>
...
Чтобы включить Авточеканку, измените 'enablezeromint = 0' на 'enablezeromint = 1' в файле reex.conf</translation>
    </message>
</context>
<context>
...
- включить: добавить 'enablezeromint = 1' в reex.conf
- отключить: добавить 'enablezeromint = 0' в reex.conf
