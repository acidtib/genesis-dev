                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("WeyCash") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a WEYC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and reecore: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About WeyCash"), this);
    aboutAction->setStatusTip(tr("Show information about WeyCash"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for reecore"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your WEYC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified WEYC addresses"));
    ...
    openAction->setStatusTip(tr("Open a reecore: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the WeyCash help message to get a list with possible reecore command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("WeyCash client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to reecore network", "", count));
}
