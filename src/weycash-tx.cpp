...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("weycash Core weycash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  weycash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded weycash transaction") + "\n" +
                               "  weycash-tx [options] -create [commands]   " + _("Create hex-encoded weycash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded weycash transaction
